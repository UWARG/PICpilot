...
SOURCEFILES_QUOTED_IF_SPACED=AttitudeManager.c OrientationControl.c StateMachine.c ../Common/Common.c ../Common/clock.c ../Common/UART1.c ../Common/debug.c InterchipDMA.c StartupErrorCodes.c net_outbound.c net_inbound.c net_common.c UART2.c cameraManager.c Probe_Drop.c InputCapture.c OutputCompare.c PWM.c fmath.c delay.c StringUtils.c timer.c VN100.c VN_lib.c VN_math.c VN_user.c Anaconda.c DisplayQuad.c main.c
...
# Source Files
SOURCEFILES=AttitudeManager.c OrientationControl.c StateMachine.c ../Common/Common.c ../Common/clock.c ../Common/UART1.c ../Common/debug.c InterchipDMA.c StartupErrorCodes.c net_outbound.c net_inbound.c net_common.c UART2.c cameraManager.c Probe_Drop.c InputCapture.c OutputCompare.c PWM.c fmath.c delay.c StringUtils.c timer.c VN100.c VN_lib.c VN_math.c VN_user.c Anaconda.c DisplayQuad.c main.c
...
${OBJECTDIR}/Probe_Drop.o: Probe_Drop.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Probe_Drop.o.d 
	@${RM} ${OBJECTDIR}/Probe_Drop.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Probe_Drop.c  -o ${OBJECTDIR}/Probe_Drop.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Probe_Drop.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1    -omf=elf -mlarge-data -O1 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/Probe_Drop.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/Probe_Drop.o: Probe_Drop.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/Probe_Drop.o.d 
	@${RM} ${OBJECTDIR}/Probe_Drop.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  Probe_Drop.c  -o ${OBJECTDIR}/Probe_Drop.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/Probe_Drop.o.d"        -g -omf=elf -mlarge-data -O1 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/Probe_Drop.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
